...
export default async function start(config) {
    try {
        ...
        */
        ...
        const gitignoreData = new Uint8Array(Buffer.from(
`# Logs
logs
*.log
npm-debug.log*
...
`{
    "name": "${projectName.length > 0 ? projectName : 'my-project'}",
    "version": "1.0.0",
    "description": "",
    "type": "${projectType}",
    "main": "src/index.js",
...
app.listen(3000, () => {
    console.log('Server running on http://localhost:3000');
        ...
        await oraPromise(fs.writeFile('nodeasy.config.js', configData), { text: 'Creating nodeasy.config.js file', successText: 'Created nodeasy.config.js file', failText: 'Failed to create nodeasy.config.js file'});
